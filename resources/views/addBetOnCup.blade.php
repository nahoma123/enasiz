            ...
            <div style="border-radius:4px;background-color: #eeeeee;border:1px solid darkgrey; margin-left:2%;margin-right:2%; width:96%;" >
                <form class="form" style="padding: 10px;" method="post" action="/addCupBet/{{$cup_id}}">
                    ...
                    <div class="form-grfoup">
                        ...
                        <h4><label for="id">Cup winning odd</label></h4>
                        <div>
                            <input style="width: 40%" type="number" step="0.01" min="0" name="cup_odd" class="form-control" placeholder="Enter the odd of the team to win the cup">
                        </div>
                        <br>
